...
namespace PumpedUpKicks.Migrations.ShopDb
{
    ...
    [Migration("20181127032322_keepShoppingCartItem")]
    partial class keepShoppingCartItem
    {
            ...
            modelBuilder.Entity("PumpedUpKicks.Models.ShoppingCartItem", b =>
                {
                    ...
                    b.HasData(
                        new { ShoppingCartItemId = 1, ProductId = 1, ProductName = "Nike Air Max 97", Quantity = 2, UserId = "2077f23d-3421-4a3d-baa8-f4b67046d0df" }
                    );
                });
